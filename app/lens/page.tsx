...
export default function LensPage() {
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <div className="mx-auto max-w-[1120px] px-6 md:px-10 py-12 md:py-20">
        {/* ── Hero ── */}
        <motion.div
          ...
          <div className="flex flex-col gap-6">
            ...
            <div
              ...
              className={`
                ...
                py-12 px-6 text-center transition-all
              ...
              {loadedFile && !analyzing ? (
                ...
                <>
                  ...
                  <p className="text-[11px] text-ink/25 mt-1.5">
                    .csv files from Spotify for Artists, Chartmetric, etc.
                  </p>
                </>
              )}
            </div>
                ...
                >
                  <div className="text-center px-8">
                    ...
                    <p className="text-sm text-ink/25">
                      {pendingOutput ? "Ready — hit Run analysis" : "Select or drop a file to begin"}
                    </p>
                  </div>
                </motion.div>
              )}
        ...
        <motion.div
          ...
          className="mt-16 pt-6 border-t border-ink/8 flex items-center justify-between"
        >
