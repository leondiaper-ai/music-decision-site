...
export default function ToolCards() {
  ...
  return (
    <>
              ...
              if (isLens) {
                return (
                  <motion.button
                    ...
                    whileHover={{ y: -8 }}
                    className="group rounded-3xl border border-electric/20 bg-cream p-7 flex flex-col text-left hover:border-electric/50 transition-colors cursor-pointer"
                  >
                    {cardContent}
                  </motion.button>
                );
      ...
      {/* Lens demo modal */}
      <TryTheLens open={demoOpen} onClose={() => setDemoOpen(false)} />
    </>
  );
}
